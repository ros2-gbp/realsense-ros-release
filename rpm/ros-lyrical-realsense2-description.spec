...
%global pkg_name realsense2_description
%global normalized_pkg_name %{lua:return (string.gsub(rpm.expand('%{pkg_name}'), '_', '-'))}

Name:           ros-lyrical-realsense2-description
Version:        4.58.4
Release:        1%{?dist}
...
* Wed Apr 29 2026 LibRealSense ROS Team <rsswsdk@realsensecloud.onmicrosoft.com> - 4.57.7-3
- Autogenerated by Bloom

* Tue Apr 28 2026 LibRealSense ROS Team <rsswsdk@realsensecloud.onmicrosoft.com> - 4.57.7-2
- Autogenerated by Bloom

* Tue Apr 21 2026 LibRealSense ROS Team <rsswsdk@realsensecloud.onmicrosoft.com> - 4.57.7-1
- Autogenerated by Bloom
